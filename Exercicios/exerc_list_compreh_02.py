...
# a) O objetivo é identificar quem são os clientes inadimplentes e enviar essa lista de clientes para o setor de cobrança poder fazer a cobrança dos clientes.
# b) Queremos então criar uma lista com os clientes inadimplentes (apenas o CPF e o valor que eles estão devendo)
...
clientes_inadimplentes = [(cliente, valor) for cliente, valor, dias in clientes_devedores if dias > 20]
